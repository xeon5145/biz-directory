...
<nav class="sticky relative top-4 flex flex-row justify-between gap-4 ml-5 mr-5">
    ...
    <div class="w-1/3 flex justify-end">
        <a href="/auth" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
            Login
        </a>
    </div>
</nav>
